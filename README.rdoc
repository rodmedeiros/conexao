...
* Projeto Rails (v 4.2.5.1)

* Rake (v 10.5.0)

* Testes pré-configurados (rspec, vcr para testes de webservices, shoulda-matchers, capybara, database_cleaner)
...
* letter_opener configurado para abrir emails em desenvolvimento (veja development.rb)
...
* Configurar o database (Escolher o banco - mysql, pg, oracle, etc...)
